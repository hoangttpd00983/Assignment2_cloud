...
<!-- trang hien tai cua tong so trang -->
        ...
        <!-- hien trang dau -->
            <a href="index.php?p=1">Trang đầu</a>
<!-- hien trang sau -->
<?php if ($p>1) {
	$p1=$p-1;
?>
<a href="index.php?p=<?php echo $p1; ?>"><img src="images/icon/1328101938_Arrow-Right.png" width="40" height="20"/></a>&nbsp;
<?php } ?>	
...
<?php if ($p<$tongsotrang) {
	$p2=$p+1;
?>
<a href="index.php?p=<?php echo $p2; ?>"><img src="images/icon/1328101938_Arrow-left.png" width="40" height="20" /></a>&nbsp;
<?php } ?>
<?php
               if($p=$tongsotrang)
               { 
                   $trangcuoi=$p;
           ?>
                   <a href="index.php?p=<?php echo $trangcuoi; ?>">Trang cuối</a>
               <?php } ?>
</p>
</body>
</html>