...
var AVIMGlobalConfig = {
	...
	controlCSS: "css/avim.css" //Path to avim.css
};
...
function AVIM()	{
	...
	if(AVIMGlobalConfig.showControl) {
		...
		document.write('<p class="AVIMControl">');
		...
		document.write('<a class="AVIMControl" style="float: right; position: relative; top: 3px;" onclick="document.getElementById(' + "'AVIMControl').style.display='none';" + '">[Ẩn - F12]</a></p>');
		document.write('</span>');
	}
