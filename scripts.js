	...
	*/
	function processReqChange() 
	{
		...
		
		{
			...
			{
				document.getElementById("UserName").innerHTML="Tên đăng nhập đã tồn tại, vui lòng chọn tên khác !";
				document.getElementById("dangky").disabled=true;
				 // xu ly ket qua tra ve , 
			} 
			else
			{
				document.getElementById("UserName").innerHTML="Tên đăng nhập có thể dùng được !";
