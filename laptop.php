...
<div id="laptop">
 <?php
	...
	$sodong=15;
    $sonhom=5;
	$s="select * from sanpham,loaisp where sanpham.idLoai=loaisp.idLoai and idCL='2'";
  ...
  $x=($p-1)*$sodong;
  $s="select * from sanpham,loaisp where sanpham.idloai=loaisp.idloai and idCL=2 limit $x,$sodong";
  $kq=mysql_query($s,$link);
...
<!-- trang hien tai cua tong so trang -->
        ...
        <!-- hien trang dau -->
            <a href="index.php?act=laptop&p=1">Trang đầu</a>
<!-- hien trang sau -->
<?php if ($p>1) {
	$p1=$p-1;
?>
...
<?php
               ...
               { 
                   $trangcuoi=$p;
           ?>
                   <a href="index.php?act=laptop&p=<?php echo $trangcuoi; ?>">Trang cuối</a>
               <?php } ?>
</p>
</body>
</html>