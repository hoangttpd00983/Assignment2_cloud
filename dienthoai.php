...
$(document).ready(function(){
    ...
    $('#dienthoai>div>img').hover(function(){
...
#dienthoai div.info span,#main_phim div.info p{
	color:black;
	font-weight:bold;
	text-align:left;
	margin:2px 4px;
}
#dienthoai div.info span{
	font-weight:normal;
}
#dienthoai div.info p.title{
	color:#DE7401;
	margin:5px;
	text-align:center;
	font-size:17px;
...
<div id="dienthoai">
 <?php
	...
	$sodong=15;
    $sonhom=5;
	$s="select * from sanpham,loaisp where sanpham.idLoai=loaisp.idLoai and idCL=1";
  ...
  $x=($p-1)*$sodong;
  $s="select * from sanpham,loaisp where sanpham.idloai=loaisp.idloai and idCL=1 limit $x,$sodong";
  $kq=mysql_query($s,$link);
...
<!-- trang hien tai cua tong so trang -->
        ...
        <!-- hien trang dau -->
            <a href="index.php?act=dienthoai&p=1">Trang đầu</a>
<!-- hien trang sau -->
<?php if ($p>1) {
	$p1=$p-1;
?>
<a href="index.php?act=dienthoai&p=<?php echo $p1; ?>"><img src="images/icon/1328101938_Arrow-Right.png" width="40" height="20"/></a>&nbsp;
<?php } ?>	
...
if ($i==$p)
   ...
   {
 ?>
 <a href="index.php?act=dienthoai&p=<?php echo $i; ?>"><?php echo $i; ?></a>
<?php
   }
}
}
...
<?php if ($p<$tongsotrang) {
	$p2=$p+1;
?>
<a href="index.php?act=dienthoai&p=<?php echo $p2; ?>"><img src="images/icon/1328101938_Arrow-left.png" width="40" height="20" /></a>&nbsp;
<?php } ?>
<?php
               if($p=$tongsotrang)
               { 
                   $trangcuoi=$p;
           ?>
                   <a href="index.php?act=dienthoai&p=<?php echo $trangcuoi; ?>">Trang cuối</a>
               <?php } ?>
</p>
</body>
</html>