...
input {border-radius:0px; margin-top:10px}
td {margin-top:10px}
label {float:right; margin-top:15px; font-size:14px;color:#3B3B3B}
select{height:30px}
  </style>
</head>
...
<div id="dangki">
	...
	<table border = "0" cellspacing = "0" cellpadding = "5" width = "598px">
		<tr>
			<td colspan = "2" align = "left" style = "color:#000;">
			<H2 style="font-weight:normal; color:#6F6B65;font-size:18px">ĐĂNG KÝ TÀI KHOẢN</H2>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td valign = "top" >
				<label for = "email">Địa chỉ email:</label><br><br>
		...
		<tr>
			...
			<td><select name = "sex" style="margin-top:10px;">
				<option>Nam</option>
				<option>Nữ</option>
		...
		<tr>
			<td valign = "top">
				<label for = "phone">Điện thoại:</label><br><br>
				<label for = "address">Địa chỉ:</label>
			</td>
			<td>
				<input type = "text" name = "phone" id = "phone" size = "40" maxlength = "11"/><br>
...
Các bài viết bộc lộ quan điểm của người viết bài, không nhất thiết là quan điểm của diễn đàn. Bất kỳ thành viên nào cảm thấy một bài viết có nội dung không lành mạnh thì xin hãy thông báo cho chúng tôi biết bằng email. Chúng tôi có khả năng xóa bài viết có nội dung không lành mạnh và chúng tôi sẽ cố gắng để làm như thế trong thời gian sớm nhất nếu chúng tôi xét thấy việc xóa bài viết là cần thiết. 
	...
	<center style="padding-bottom:50px">
	  <input style="color:#000" type = "button" id = "dangky" name = "dangky" value = "Đăng ký" onClick="kiemtra()" disabled="disabled"/>
